...
package cm.framework.img.cache;
...
import cm.framework.img.bus.SimpleBus;
import cm.framework.img.task.AsyncTaskEx;

public class WebImageCache extends AsyncCache<String, Drawable, SimpleBus, Bundle> {
	private static String TAG = WebImageCache.class.getSimpleName ( );
	private Drawable placeholder = null;

	static public File buildCachedImagePath ( File cacheRoot, String url ) throws Exception {
	...
	public WebImageCache ( File cacheRoot, SimpleBus bus, AsyncCache.DiskCachePolicy policy, int maxSize, Drawable placeholder ) {
		super ( cacheRoot , bus , policy , maxSize );

		this.placeholder = placeholder;
	}

	public void handleImageView ( final ImageView image, final String url, String tag ) throws Exception {
