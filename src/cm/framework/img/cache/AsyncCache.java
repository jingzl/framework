...
abstract public class AsyncCache<K, V, B extends AbstractBus, M> extends CacheBase<K, V> {
	protected abstract V create ( K key, M message, int forceStyle );

	private static String TAG = AsyncCache.class.getSimpleName ( );
	private B bus = null;

	public AsyncCache ( File cacheRoot, B bus, DiskCachePolicy policy, int maxSize ) {
