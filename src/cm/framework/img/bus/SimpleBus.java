...
public class SimpleBus extends AbstractBus<Bundle, String, SimpleBus.IntentMatchStrategy> {
	...
	class IntentMatchStrategy implements AbstractBus.Strategy<Bundle, String> {
		public boolean isMatch ( Bundle message, String filter ) {
			return ( filter != null && message != null && filter.equals ( message.getString ( KEY ) ) );
		}
	}
}
